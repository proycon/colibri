...
class AlignmentModel: public AlignConstraintInterface, public ModelQuerierBase {
   ...
   public:
	...
	int extractgizapatterns2(GizaModel & gizamodel_s2t, GizaModel & gizamodel_t2s, int pairoccurrencethreshold=0, const double coocthreshold=0, const double alignscorethreshold = 0.5, int computereverse = 2, bool bestonly = true, bool weighbyalignmentscore = true, bool expandunaligned = false, bool combine = false, double unionweight = 1.1, ClassDecoder * sourcedecoder = NULL, ClassDecoder * targetdecoder = NULL);
